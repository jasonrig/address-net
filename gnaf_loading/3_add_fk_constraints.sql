...
--
-- Original from: g-naf_aug22_allstates_gda2020_psv_108/G-NAF/Extras/ via
-- https://data.gov.au/data/dataset/geocoded-national-address-file-g-naf
--

-- Aug 2022 Error - can skip this step:
-- ERROR:  insert or update on table "address_detail" violates foreign key constraint "address_detail_fk1"
-- DETAIL:  Key (address_site_pid)=(710752317) is not present in table "address_site".
-- SQL state: 23503
